...
export const TOOL_CALL_LAYOUTS = ["individual", "aggregate", "per-turn"] as const;
...
export function usesAggregateLedger(layout: ToolCallLayout): boolean {
	return layout === "aggregate" || layout === "per-turn";
}
